...
const PrivacyPolicyPage: NextPage = () => {
    return (
        <>
            <Head title="Real Cost - Chính sách riêng tư" />

            <Section
                style="px-4 mx-auto h-full w-full md:max-w-[644px] pt-36 lg:max-w-[1200px] space-y-6"
                title="Chính sách riêng tư"
            >
                <h1 className="text-[17px] md:text-3xl">
                    Quyền riêng tư của bạn rất quan trọng với chúng tôi.
                </h1>
                <p className="lg:w-1/2">
                    Chính sách của Real Cost là tôn trọng quyền riêng tư của bạn
                    liên quan đến bất kỳ thông tin nào mà chúng tôi có thể thu
                    thập khi vận hành trang web của mình. Theo đó, chúng tôi đã
                    phát triển chính sách bảo mật này để bạn hiểu cách chúng tôi
                    thu thập, sử dụng, giao tiếp, tiết lộ và nói cách khác là sử
                    dụng thông tin cá nhân. Chúng tôi đã phác thảo chính sách
                    bảo mật của chúng tôi bên dưới.
                </p>
                <h1 className="text-[17px] md:text-3xl">Chính sách:</h1>
